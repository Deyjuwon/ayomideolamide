  ...
  return (
    <div>
      ...
      <div className='w-full'>
        <img src={aa7} alt="" className='lg:h-screen w-full object-cover' />
      </div>
        ) : (
      ...
      <section className='flex flex-col gap-4 lg:flex-row items-center justify-center py-10 bg-gradient-to-b md:bg-gradient-to-r from-white to-yellow1 text-darkBlack'>
        ...
        <div className='lg:w-1/2 w-full flex flex-col gap-5 px-4 md:px-14' data-aos='fade-left'>
          <p className='lg:text-sm  text-sm lg:pr-20 lg:leading-8 leading-6  '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti vitae similique accusantium velit dolores explicabo quaerat reiciendis fugiat tenetur obcaecati beatae odit aut recusandae quod architecto omnis, sed provident impedit.
      ...
      <div className=' flex justify-center md:gap-20 items-center px-4'>
        ...
        <div className='flex flex-col text-sm border gap-2 h-full   w-full justify-between rounded-lg p-4  md:p-8 bg-gradient-to-b md:bg-gradient-to-r from-white to-yellow1 text-darkBlack'>
          <p className='text-sm lg:text-sm'>{testimonialData[currentIndex].testimony}</p>
          <div className='flex gap-4 items-center'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-500'>{testimonialData[currentIndex].position}</p>
            </div>
          </div>
        </div>
